  ...
  if (!order) {
    return (
      <div className="bg-[#0B0D1A] min-h-screen pt-24 flex flex-col items-center justify-center text-center px-6">
        ...
        <p className="text-white/50 mb-8">We couldn't find this order. Please check your order ID.</p>
      ...
      <section className="py-10 px-6 md:px-10">
        <div className="max-w-3xl mx-auto">
          ...
          >
            ...
            <p className="text-white/50 text-lg">Your order has been confirmed</p>
          </motion.div>
          ...
          >
            ...
            >
              <p className="text-white/50 text-xs mb-1 m-0">Order ID</p>
            ...
            {tickets.length > 0 && (
              <div className="mb-6">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <h3 className="text-white font-bold text-sm m-0">Tickets</h3>
                </div>
                    ...
                    <div key={i} className="flex items-center justify-between py-2 border-b border-white/5 last:border-none">
                      <div>
                        ...
                        <div className="flex gap-2 mt-0.5">
                          {item.size && <span className="text-white/30 text-xs">Size: {item.size}</span>}
                ...
                {order.deliveryMethod && (
                  ...
                  >
                    <p className="text-white/50 text-xs m-0">
                      Delivery: {order.deliveryMethod === 'pickup' ? 'Pickup at Event Venue' : 'Shipping to Address'}
                    </p>
